...
import {scalar, zerosLike} from '@tensorflow/tfjs';

import {ConfigDict, registerClass, Serializable, SerializableConstructor} from '@tensorflow/tfjs-core';
import {Scalar, Tensor} from '@tensorflow/tfjs-core';
import {NamedTensor, NamedVariableMap} from '@tensorflow/tfjs-core';
